...
| What | Where |
|---|---|
| **Ecosystem-extensions initiative** | `claude-copilot` repo, [`docs/80-initiatives/01-ecosystem-extensions/`](https://github.com/Everyone-Needs-A-Copilot/claude-copilot/tree/ecosystem-extensions/docs/80-initiatives/01-ecosystem-extensions) — branch `ecosystem-extensions` |
