...
- `../04-validation/redteam-platform.md` ("Red Team B") and `../04-validation/redteam-use-cases.md` ("Red Team A") — the two adversarial red-team reports [`threat-model.md`](threat-model.md) cites directly by finding ID rather than re-deriving.
