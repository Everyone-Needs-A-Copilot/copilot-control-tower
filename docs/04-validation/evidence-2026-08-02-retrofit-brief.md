...
>
> **Known error in this brief, corrected 2026-08-03 — left in place deliberately.** The "Native design triad" row below gives the wrong paths. It names `docs/03-design/ui-ux/control-tower-native-experience-architecture.md`, `…-interaction-spec.md` and `…-visual-system.md`. The real files are one directory up and two of them lack the `native-` prefix: [`docs/03-design/control-tower-native-experience-architecture.md`](../03-design/control-tower-native-experience-architecture.md), [`docs/03-design/control-tower-interaction-spec.md`](../03-design/control-tower-interaction-spec.md), and [`docs/03-design/control-tower-visual-system.md`](../03-design/control-tower-visual-system.md). `docs/03-design/ui-ux/` contains only a README that indexes them. The error originated here and propagated into two documents written from this brief; both were corrected on 2026-08-03 and no document now carries a broken link. It is preserved rather than patched because this file's whole value is being a faithful record of what the agents were actually told — and because it is a small, live demonstration of the failure mode the audit is about: a confidently-stated path that nobody checked.
