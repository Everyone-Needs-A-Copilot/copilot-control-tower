...
1.7.16 universal artifact and must pass
...
Current source truth: the checked-in cc 1.7.16 package and revised native
implementation pass **40/40 (100%)** with zero critical failures. The signed,
notarized 0.2.3 release artifact passed the previous matrix against its exact
embedded cc 1.7.15 helper. Earlier releases remain historical.
