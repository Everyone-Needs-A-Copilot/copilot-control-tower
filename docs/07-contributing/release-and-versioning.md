...
Related: [`../01-architecture/architecture.md`](../01-architecture/architecture.md) §7 (self-update) and §8.3 (signed-inherited-config managed keys), `design-distribution.md` §1 and §4 (signing/notarization detail, superseded on process model only), [`../05-security/credentials-and-boundary.md`](../05-security/credentials-and-boundary.md), [`../05-security/threat-model.md`](../05-security/threat-model.md) (B4, the self-update trust chain).
