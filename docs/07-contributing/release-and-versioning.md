...
2. `claude-copilot` CI publishes the new signed/notarized CLI artifact at a pinned SHA+version (the cross-repo signing contract — Control Tower CI verifies, never re-signs).
