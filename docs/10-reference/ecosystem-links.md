...
| **Product Creation Copilot** | `/Volumes/Dev/Sites/CSE/product-creation-copilot` — the conversational product-design tool used for Control Tower's UI/UX track (see [`../03-design/ui-ux/README.md`](../03-design/ui-ux/README.md)) |
