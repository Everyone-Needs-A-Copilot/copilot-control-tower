...
> (`docs/10-reference/cse-alignment-decisions.md`): Control Tower syncs the CSE tooling
...
| **Earl — IT / Admin operator** (the enabler) | To stand up and deploy the whole ecosystem from a guided tool + docs alone — no hand-YAML, no hand-crafted profiles; a fleet he can see, trust, and govern centrally. | **HYPOTHESIS** — no real IT operator has touched it |
...
11. **CSE alignment (ratified, `docs/10-reference/cse-alignment-decisions.md`).** An audit
