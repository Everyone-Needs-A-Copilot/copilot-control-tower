...
```
src-tauri/fixtures/connections/
  README.md   this file
...
```bash
CT_FIXTURE=store-unreachable src-tauri/fixtures/mock-cc connections --json
...
CT_FIXTURE=exit-2 src-tauri/fixtures/mock-cc connections --json
...
CT_FIXTURE=verb-unavailable src-tauri/fixtures/mock-cc connections --json
```
