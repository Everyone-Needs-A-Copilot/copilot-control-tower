...
CT_FIXTURE=applied-clean \
  scripts/tests/fixtures/mock-cc update --json

# adversarial: the honest unsigned default
CT_FIXTURE=missing-signed scripts/tests/fixtures/mock-cc update --json

# fail-closed
CT_FIXTURE=missing-op scripts/tests/fixtures/mock-cc update --json

# env error / flock-held path
CT_FIXTURE=exit-2 scripts/tests/fixtures/mock-cc update --json
```
