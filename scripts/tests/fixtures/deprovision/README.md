...
```
scripts/tests/fixtures/deprovision/
  README.md   this file
...
CT_FIXTURE=wiped-clean \
  scripts/tests/fixtures/mock-cc deprovision acme-corp --json

# adversarial: the honest alarm
CT_FIXTURE=secrets-touched-alarm scripts/tests/fixtures/mock-cc deprovision acme-corp --json

# fail-closed
CT_FIXTURE=malformed scripts/tests/fixtures/mock-cc deprovision acme-corp --json

# env error / flock-held path
CT_FIXTURE=exit-2 scripts/tests/fixtures/mock-cc deprovision acme-corp --json
```
