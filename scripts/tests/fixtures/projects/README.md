...
```
scripts/tests/fixtures/projects/
  README.md   this file
...
CT_FIXTURE=mixed-fresh-and-stale scripts/tests/fixtures/mock-cc freshness --all-projects --json

# fan-out roll-up, happy-ish path
CT_FIXTURE=12-of-14-updated scripts/tests/fixtures/mock-cc update --fanout --json

# fan-out roll-up, everything held on dirty WIP
CT_FIXTURE=all-held-dirty scripts/tests/fixtures/mock-cc update --fanout --json
...
# NOT this directory)
scripts/tests/fixtures/mock-cc update --project /path/to/some-project --json
```
