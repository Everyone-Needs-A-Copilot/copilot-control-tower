...
#   --claude-root PATH   claude-copilot checkout. Required unless
#                         $CT_TOPOLOGY_CLAUDE_ROOT is set.
...
CLAUDE_ROOT="${CT_TOPOLOGY_CLAUDE_ROOT:-}"
CC_PATH=""
SOURCE_CC=""
KEEP=false
...
[[ -n "${CLAUDE_ROOT}" ]] ||
    die "pass --claude-root or set CT_TOPOLOGY_CLAUDE_ROOT"
